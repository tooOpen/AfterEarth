...
bool TitleScene::init() {
	...
	_stageButton = MenuItemImage::create(
		"titlescene/images/resetbtn.png",
		"titlescene/images/resetbtnclicked.png",
		CC_CALLBACK_1(TitleScene::menuCloseCallback, this));
...
void TitleScene::titleRotateAction(float f)
{
	...
	auto texture1 = Director::getInstance()->getTextureCache()->addImage("titlescene/images/planet1.png");
	...
	auto texture2 = Director::getInstance()->getTextureCache()->addImage("titlescene/images/planet2.png");
